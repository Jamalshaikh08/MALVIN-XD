...
module.exports = {
SESSION_ID: process.env.SESSION_ID || "MALVIN-XD~0pB2TboB#oMEg5TLRQjPJ_tmSz86h6Pz2ym7oQGAyk4Dwr7pdbao",
// add your Session Id 
...
STICKER_NAME: process.env.STICKER_NAME || "丂HAشیخIKH",
...
OWNER_NUMBER: process.env.OWNER_NUMBER || "923152983381",
// add your bot owner number

OWNER_NAME: process.env.OWNER_NAME || "丂HAشیخIKH",
// add bot owner name

DESCRIPTION: process.env.DESCRIPTION || "> *© ᴘᴏᴡᴇʀᴇᴅ ʙʏ ✦Јдмдг Ѕндİкн✦ ɪɴᴄ*",
// add bot owner name    
...
DEV: process.env.DEV || "923152983381",
